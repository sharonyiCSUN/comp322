...
In order for you to run this program, you must download the repository, locate the directory and then compile the project. You must type in "make ALL" to compile, then from there type in "./time-4-baby-and-me" in your console/command line. Your program then should have displayed certain outputs described below.
